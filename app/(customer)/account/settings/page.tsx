          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-text-muted text-sm font-light">
                اختر اللغة التي تفضل استخدامها في المتجر
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            {['ar', 'en'].map((lang) => (
              ...
              >
                ...
                >
                  {language === lang && (
                    <div className="w-2 h-2 rounded-full bg-text-on-gold" />
                  )}
                </div>
              </button>
            ))}
        ...
        <section className="glass-card rounded-3xl p-8 md:p-12 space-y-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-text-muted text-sm font-light">
                إدارة كيف ومتى تتلقى الإشعارات منا
              </p>
            </div>
          </div>
            ...
            {[
              {
                ...
                desc: 'الحصول على إشعارات حول حالة طلبك وتأكيد الاستلام',
              },
              {
                id: 'offers',
                label: 'العروض الحصرية',
                desc: 'تلقي تنبيهات حول الخصومات والمنتجات الجديدة',
              },
              {
                id: 'support',
                label: 'رسائل الدعم',
                desc: 'تلقي تنبيهات عند الرد على تذاكر الدعم الخاصة بك',
              },
            ].map((item) => (
              <div
                key={item.id}
              ...
              >
                <div className="space-y-1 text-right">
                  ...
                  <p className="text-text-fade text-[11px] font-light">
                    {item.desc}
                  </p>
                </div>
        ...
        <section className="glass-card rounded-3xl p-8 md:p-12 space-y-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-text-muted text-sm font-light">
                تغيير كلمة المرور وإدارة أمان حسابك
              </p>
            </div>
          </div>
