...
import { ShoppingBag, ChevronLeft, Calendar, Hash } from 'lucide-react';
    ...
    <div className="space-y-10">
      ...
      {orders.length === 0 ? (
        <div className="glass-card rounded-3xl p-20 text-center space-y-6">
          ...
          <Link
            href="/products"
            className="inline-block px-10 py-4 bg-gold text-text-on-gold rounded-full font-bold text-xs uppercase tracking-widest hover:bg-gold-light transition-all shadow-gold"
          >
            تصفح المنيو
          </Link>
        </div>
