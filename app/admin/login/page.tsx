...
export default function AdminLoginPage() {
    ...
    const handleLogin = async (e: React.FormEvent) => {
        ...
        // ✅ قبول owner و super_admin و operations
    ...
    return (
        <div
            className="min-h-screen bg-[#0a0a0b] flex items-center justify-center px-6"
        ...
        >
            <div className="w-full max-w-sm">
                <div className="text-center mb-10">
                    ...
                    <p className="text-sm text-white/40 mt-1">لوحة التحكم</p>
                </div>
                    ...
                    <div className="space-y-1.5">
                        ...
                        <div className="relative">
                            <input
                                ...
                                className="w-full h-12 bg-white/5 border border-white/10 rounded-xl px-4 pl-11 text-sm text-white placeholder:text-white/20 focus:border-[#c9a84c]/50 outline-none transition-all"
